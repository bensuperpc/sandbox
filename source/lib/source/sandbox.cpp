...
benlib::Gol::Gol(const std::vector<uint8_t>& _grid1D,
...
void benlib::Gol::SetCell(const uint64_t x,
                          const uint64_t y,
                          const uint8_t alive)
{
...
uint64_t benlib::Gol::GetNeighborsCount(const std::vector<uint8_t>& _grid,
                                        const uint64_t width,
                                        const uint64_t height,
                                        const uint64_t x,
                                        const uint64_t y,
...
void benlib::Gol::Circle(const uint64_t x,
                         const uint64_t y,
                         const uint64_t r,
                         const uint8_t alive)
{
